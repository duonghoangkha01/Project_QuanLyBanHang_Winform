    ...
    public partial class Form13 : Form
    {
        ...
        private void LoadData()
        {
            try
            {
                ...
                // Đưa dữ liệu lên ComboBox ChonNhanVien
                this.cboChonNhanVien.DataSource = dtNhanVien;
                this.cboChonNhanVien.DisplayMember = "Ten";
                this.cboChonNhanVien.ValueMember = "MaNV";
                // Vận chuyển dữ liệu vào DataTable dtHoaDon
                daHoaDon = new SqlDataAdapter("SELECT * FROM HOADON WHERE MANV = '" + this.cboChonNhanVien.SelectedValue + "'", conn);
